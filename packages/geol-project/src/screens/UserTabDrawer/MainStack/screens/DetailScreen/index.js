  ...
  return (
    <ScrollView style={{backgroundColor: '#fff', flex: 1}}>
      <View>
        ...
        />
        <View
          style={{flexDirection: 'row', marginHorizontal: 16, paddingTop: 20}}>
          ...
          <Text
            ...
            utility internal combustion engine or, more commonly, an electric
            motor.{' '}
          </Text>
        </View>
        <View
          style={{flexDirection: 'row', marginHorizontal: 16, paddingTop: 16}}>
        ...
        <View
          ...
          <Text
            ...
            Ride on bike lanes, car roads and sidewalks. Don’t block public
            pathways, park by bike racks when available
          </Text>
        </View>
      </View>
    </ScrollView>
